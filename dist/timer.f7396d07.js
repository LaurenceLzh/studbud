...
function tomatoUpdate(timeStr, minutes, status) {
    ...
    if (status === 'BREAK') timerTop.style.backgroundColor = '#a0f4ea';
    else timerTop.style.backgroundColor = '#f4a261';
...
function timeStart() {
    ...
    time.innerHTML = (minutes < 10 ? "0" + minutes : minutes) + ":" + (seconds < 10 ? "0" + seconds : seconds) + ":" + (ms < 10 ? "0" + ms : ms);
}

//# sourceMappingURL=timer.f7396d07.js.map
