/* Set the width of the sidebar to 250px (show it) */ let show = true;
...
tomatoTime.addEventListener('click', ()=>{
    ...
    else tomatoEndTime = Date.now() + duration;
});
let musicIndex = 0;
let currentMusic;
let musicInterval;
...
function playEnd() {
    ...
    } else musicIndex = Math.floor(Math.random() * 4);
    playMusic();
...
//# sourceMappingURL=index.030a5644.js.map
